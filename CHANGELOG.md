...
- **DevQuest (The Open-Source RPG)**: Built a turn-based RPG engine (`DevQuest.tsx`) on the Games Hub. The entire game universe (monsters, items) is powered by community-contributed JSON files. Features level-scaling, roguelike mechanics, and Framer Motion combat animations.
